 ...
 */
function AndMemories_custom_colors_css() {
	$hue = absint( get_theme_mod( 'colorscheme_hue', 250 ) );

	/**
	 * Filter And Memories default saturation level.
	 *
	 * @since And Memories 1.0
	 *
	 * @param int $saturation Color saturation level.
	 */
	$saturation         = absint( apply_filters( 'AndMemories_custom_colors_saturation', 50 ) );
...
.colors-custom.page:not(.AndMemories-front-page) .entry-title,
...
.colors-custom .AndMemories-panel .recent-posts .entry-header .edit-link {
...
.colors-custom.AndMemories-front-page .panel-content .recent-posts article,
...
.colors-custom.AndMemories-front-page article:not(.has-post-thumbnail):not(:first-child),
...
@media screen and (min-width: 48em) {
	...
	/**
	 * Filters And Memories custom colors CSS.
	 *
	 * @since And Memories 1.0
	 *
	 ...
	 */
	return apply_filters( 'AndMemories_custom_colors_css', $css, $hue, $saturation );
}
